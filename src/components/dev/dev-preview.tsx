...
export function DevPreview() {
  ...
  const [selectedMessage, setSelectedMessage] = useState<DevMessage | null>(
    null,
  );
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <DialogDescription className="text-base max-w-3xl">
                  View and manage your development notifications, including
                  emails, SMS, and WhatsApp messages.
                </DialogDescription>
              </div>
            </div>
          </DialogHeader>
