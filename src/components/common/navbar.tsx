...
import { UserIcon, LogOut, CheckCheck, ListTodo } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export function Navbar({ user: serverUser }: NavbarProps) {
  // Use useSession to get real-time auth state
  const { data: session } = useSession();
  // Use session.user if available, otherwise fall back to server-provided user
