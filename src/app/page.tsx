      ...
      <div className="flex flex-col items-center justify-center text-center h-full space-y-10 py-10">
        <div className="space-y-4">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            A simple and powerful todo application to help you manage your tasks
            effectively. Browse public todos or sign in to create and manage
            your own.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                Easily find todos with our powerful search and filter
                capabilities
              </p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                Create, edit, and delete your tasks with a beautiful interface
              </p>
            </div>
            <div className="space-y-2">
              <h3 className="text-lg font-medium">User Profiles</h3>
              <p className="text-muted-foreground">
                Manage your profile and keep track of all your todos in one
                place
              </p>
            </div>
          </div>
