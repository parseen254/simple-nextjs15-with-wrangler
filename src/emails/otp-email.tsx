        ...
        <Body className="bg-gray-50 my-auto mx-auto font-sans">
          <Container className="my-[40px] mx-auto w-[465px] rounded-lg overflow-hidden">
            ...
            <Section className="bg-white px-8 py-10">
              ...
              <Text className="text-gray-700 text-base mb-6">
                Thanks for keeping your account secure. Please use the
            ...
            <Section className="bg-white px-8 py-6">
              <Text className="text-gray-500 text-xs text-center">
                This is an automated message, please do not reply. We will never
                ask for your password or personal information via email.
              </Text>
